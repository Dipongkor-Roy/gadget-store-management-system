			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<br><img src="../images/product_images/<?php echo $p_image1; ?>" width="70" height="70">
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Product Image 2</label>
						<input type="file" name="product_img2" class="form-control" >
						<br><img src="../images/product_images/<?php echo $p_image2; ?>" width="70" height="70">
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Product Image 3</label>
						<input type="file" name="product_img3" class="form-control" >
						<br><img src="../images/product_images/<?php echo $p_image3; ?>" width="70" height="70">
					</div>
					<div class="form-group">
